...
const ContactForm: React.FC = () => {
  ...
  return (
    <section className="container mx-auto p-4 text-center">
      <h2 className="text-yellow-400 font-bold mb-4">Contact Form with Rating</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-left font-semibold text-yellow-400" htmlFor="name">Nama:</label>
          <input
            type="text"
            id="name"
            value={name}
        ...
        <div>
          <label className="block text-left font-semibold text-yellow-400" htmlFor="comment">Komentar:</label>
          <textarea
            id="comment"
            value={comment}
        ...
        <div>
          <label className="block text-left font-semibold text-yellow-400">Rating:</label>
          <div className="flex space-x-1">
            {[1, 2, 3, 4, 5].map((star) => (
              <button
                ...
                className={`text-2xl ${star <= rating ? 'text-yellow-500' : 'text-yellow-300'}`}
              >
                ★
              </button>
            ))}
      ...
      <div className="mt-8">
        <h3 className="text-lg font-bold text-yellow-400">Average Rating</h3>
